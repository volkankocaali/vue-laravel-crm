                ...
                <div class="flex h-screen bg-gray-100 dark:bg-gray-800 font-roboto">
                    ...
                    <div :class="sideBarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
                        ...
                        <nav class="flex flex-col mt-10 px-4 text-left">
                            <router-link exact-active-class="text-gray-700 dark:text-gray-100 bg-gray-200 dark:bg-gray-800" :to="{name : 'home' }"
                               class="flex py-2 pl-8 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-800 rounded">
                            ...
                            <router-link exact-active-class="text-gray-700 dark:text-gray-100 bg-gray-200 dark:bg-gray-800" :to="{ name : 'profile'}"
                            ...
                            <router-link exact-active-class="text-gray-700 dark:text-gray-100 bg-gray-200 dark:bg-gray-800" :to="{ name : 'company'}"
                               class="flex mt-3 py-2 pl-8 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-800 rounded">
                                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                    <path d="M4 3a2 2 0 100 4h12a2 2 0 100-4H4z" />
                                    <path fill-rule="evenodd" d="M3 8h14v7a2 2 0 01-2 2H5a2 2 0 01-2-2V8zm5 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z" clip-rule="evenodd" />
                                </svg>
                                <span class="mx-2">Firmalar</span>
                            </router-link>

                            <router-link exact-active-class="text-gray-700 dark:text-gray-100 bg-gray-200 dark:bg-gray-800" :to="{ name : 'person'}"
                                         class="flex mt-3 py-2 pl-8 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-800 rounded">
                                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <a href="#"
                               class="flex mt-3 py-2 pl-8 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-800 rounded">
                                ...
                                <span class="mx-2">Satış Fırsatları</span>
                            </a>
