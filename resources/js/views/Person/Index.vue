<template>
    <div class="flex flex-col space-x-3 min-h-screen">
        <div class="flex-col">
            <div>
                <h3 class="text-xl font-bold">Kişiler</h3>
            </div>
        </div>
        <div class="flex-col">
        ...
        <div class="flex-col">
            ...
            <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                <div v-if="person.data">
                    <table v-if="person.data" class="min-w-full leading-normal">
                        <thead>
                        <tr>
                        ...
                        <tr v-for="item in person.data" :key="item.id">
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white dark:bg-gray-800 dark:border-gray-500">
                                <p class="text-gray-900 dark:text-white text-sm">{{ item.person_name }}</p>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white dark:bg-gray-800 dark:border-gray-500">
                                <p class="text-gray-900 dark:text-white text-sm">{{ item.companies.company_name }}</p>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white dark:bg-gray-800 dark:border-gray-500">
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white dark:bg-gray-800 dark:border-gray-500">
                                <p class="text-gray-900 dark:text-white text-sm">{{ item.user.name }}</p>
                            </td>
...
export default {
    ...
    methods : {
        getPerson(){
            axios.get(`/persons?page=${this.$route.query.page}`).then(res => {
