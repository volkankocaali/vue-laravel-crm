                            ...
                            <div>
                                <div class="flex block dark:text-white text-gray-900">
                                    <div class="flex rounded mx-2 py-1 pt-1">
                                        ...
                                        <h3 class="mx-2">Yeni Kişi Ekle</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="mt-5">
                                    ...
                                    <div class="grid lg:grid-cols-3 gap-6">
                                        ...
                                        <div>
                                            <div class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
                                                ...
                                                <div>
                                                    <p>
                                                        <select class="py-1 px-1 dark:bg-gray-800 bg-white dark:text-white text-gray-900 outline-none block h-full w-full" name="companies_id" id="companies_id" v-model="person.companies_id">
                                                            <option value="" selected>Firma seçiniz</option>
                                                            <option v-for="item in company" :value="item.id" :key="item.id">{{ item.company_name }}</option>
                                                        </select>
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="grid lg:grid-cols-3 gap-6 my-3">
                                            <div>
                                                <div class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
                                                    ...
                                                    <div>
                                                        <p>
                                                            <select class="py-1 px-1 dark:bg-gray-800 bg-white dark:text-white text-gray-900 outline-none block h-full w-full" name="person_countries" id="person_countries" v-model="person.person_countries">
                                            ...
                                            <div>
                                                <div class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
                                                    ...
                                                    <div>
                                                        <p>
                                                            <select @change="this.getDistrict" class="py-1 px-1 dark:bg-gray-800 bg-white dark:text-white text-gray-900 outline-none block h-full w-full" name="person_cities" id="person_cities" v-model="person.person_cities">
                                            ...
                                            <div>
                                                <div class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
                                                    ...
                                                    <div>
                                                        <p>
                                                            <select class="py-1 px-1 dark:bg-gray-800 bg-white dark:text-white text-gray-900 outline-none block h-full w-full" name="person_district" id="person_district" v-model="person.person_district">
